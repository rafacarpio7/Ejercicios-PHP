...
<html>
    ...
    <body>
        ...
        $columnaArrayPosicion=array_column($arrayEquipos, 'posicion' );
        $columnaArrayPuntos=array_column($arrayEquipos, 'puntos' );

        echo "<pre>";
        print_r($columnaArrayPosicion);
        echo "</pre>";

        echo "<pre>";
        print_r($columnaArrayPuntos);
        echo "</pre>";

        $arrayOrdenado = array_multisort($arrayEquipos,$columnaArrayPosicion);
