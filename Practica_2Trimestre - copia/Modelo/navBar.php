    ...
    if (!isset($_SESSION['idUsuario'])) {
        ...
        if ($_SESSION['idUsuario']=='admin') {
            ...
            <a class="logo-inicio" href="../index.php" ><img class="logo"  src="../img/logo.png" alt="logo"></a>
                <nav>
                    <ul class="navbar">
                        <li><a href="../Vista/vista_viviendas.php?viviendasNAVBAR"> Viviendas </a></li>
                        <li><a href="../Vista/vista_usuarios.php?usuariosNAVBAR"> Usuarios </a></li>
                        <li><a href="../Vista/vista_filtros.php?filtrosNAVBAR"> Filtrar </a></li>
                    </ul>
                </nav>
